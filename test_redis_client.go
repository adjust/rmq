...
func (client *TestRedisClient) Set(key string, value string, expiration time.Duration) (bool, error) {
...
func (client *TestRedisClient) Del(key string) (affected int, ok bool, err error) {
...
func (client *TestRedisClient) TTL(key string) (ttl time.Duration, ok bool, err error) {
...
func (client *TestRedisClient) LPush(key string, value ...string) (bool, error) {
...
func (client *TestRedisClient) LLen(key string) (affected int, ok bool, err error) {
	list, err := client.findList(key)
...
func (client *TestRedisClient) LRem(key string, count int, value string) (affected int, ok bool, err error) {
...
func (client *TestRedisClient) LTrim(key string, start, stop int) (bool, error) {
...
func (client *TestRedisClient) LRange(key string, start, end int) ([]string, error) {
	...
	if end > -start {
		return list[len(list)+start:], nil
	}

	return list[len(list)+start : len(list)+start+end], nil
...
func (client *TestRedisClient) SAdd(key, value string) (bool, error) {
...
// An error is returned when the value stored at key is not a set.
func (client *TestRedisClient) SRem(key, value string) (affected int, ok bool, err error) {
